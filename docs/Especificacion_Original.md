# Especificación original del proyecto (prompt maestro)

> **Nota:** este documento es el *brief / prompt maestro* original con el que se definió el
> proyecto. Se conserva **como referencia histórica**, tal cual estaba. La descripción
> **actualizada** del sistema (con biometano, hidrógeno, el chat y las instrucciones de uso) está en
> el [README](../README.md) y en el manual [Documentacion_Comparador_Gas.md](Documentacion_Comparador_Gas.md).
