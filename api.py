...
try:
    ...
    SYSTEM_PROMPT = (
        ...
        "del gas natural (España, Portugal, Francia, Italia, Alemania, Países Bajos, Bélgica, UE). Nunca inventas valores "
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "pais": {"type": "string", "description": "País/jurisdicción (España, Portugal, Francia, Italia, Alemania, Países Bajos, Bélgica, UE)."},
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "pais_origen": {"type": "string", "description": "País de origen (España, Portugal, Francia, Italia, Alemania, Países Bajos, Bélgica, UE)."},
                },
...
def _parametro_no_reconocido_message() -> str:
    ...
    return (
        ...
        f"{opciones}\n\n"
        "Indícame uno de ellos junto con el país (España, Portugal, Francia, Italia, Alemania, Países Bajos, Bélgica o UE) "
...
def _mensaje_capacidades() -> str:
    ...
    return (
        ...
        "Portugal, Francia, Italia, Alemania, Países Bajos, Bélgica y la UE. Los parámetros que puedes consultar son:\n\n"
        f"{opciones}\n\n"
...
ALL_COUNTRIES = ["España", "Portugal", "Francia", "Italia", "Alemania", "Países Bajos", "Bélgica", "UE"]
PAIS_BASE = "España"
...
PAISES_UI = ["Portugal", "Francia", "Italia", "Alemania", "Países Bajos", "Bélgica", "UE"]  # España es siempre la base de referencia
...
PAISES_MATRIZ = ["España", "Portugal", "Francia", "Italia", "Alemania", "Países Bajos", "Bélgica", "UE"]
...
_PAISES_FUENTE = ["España", "Portugal", "Francia", "Italia", "Alemania", "Países Bajos", "Bélgica", "UE"]
